...
import { 
  Heart, Trash2, ShoppingCart, Activity, LayoutGrid, 
  Package, User, LogOut, Home, Sparkles, ChevronRight 
} from 'lucide-react';
                  ...
                  <div className="flex-1 flex flex-col justify-center text-left">
                    ...
                    <div className="flex gap-4 mt-6 text-left">
                      ...
                      <button 
                        ...
                        className="p-4 bg-white/5 hover:bg-red-500/20 text-gray-600 hover:text-red-500 transition-all border border-white/5"
                      >
                        <Trash2 size={16}/>
                      </button>
                    </div>
